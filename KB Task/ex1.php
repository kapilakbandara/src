...
<head>
    ...
    <title>Exercise 1: Getting Started with PHP - Kapila</title>
</head>
<body>
    ...
    ?>
    <h3>3.2Create a PHP variable named $title and assign it 
    ...
    <h3>3.3 Define three variables: $g1 = 5, $g2 = 4, and $g3 = 5. These variables 
        ...
        information, create an HTML table within your PHP code. The table should
         be structured with columns for Serial Number (S.n.), Name, and Grade, and 
    ...
    <h3>3.5 Take a screenshot that confirms your development environment 
        setup and include it as an image in the "ex1.php" file.</h3>
    <img src="images/2024.png" alt="web development environment">
    </body>
</html>
